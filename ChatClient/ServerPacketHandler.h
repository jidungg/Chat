...
public:
	static void Init()
	{
		...
		GPacketHandler[PKT_S_OTHER_ENTERED_ROOM] = [](PacketSessionRef& session, BYTE* buffer, int32 len) {return HandlePacket<Protocol::S_OTHER_ENTERED_ROOM >(Handle_S_OTHER_ENTERED_ROOM, session, buffer, len); };
		GPacketHandler[PKT_S_OTHER_LEAVED_ROOM] = [](PacketSessionRef& session, BYTE* buffer, int32 len) {return HandlePacket<Protocol::S_OTHER_LEAVED_ROOM >(Handle_S_OTHER_LEAVED_ROOM, session, buffer, len); };
