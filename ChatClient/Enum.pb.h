...
enum UserType : int {
  ...
  UserType_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::min(),
  UserType_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::max()
};
bool UserType_IsValid(int value);
constexpr UserType UserType_MIN = PLAYER_TYPE_NONE;
constexpr UserType UserType_MAX = PLAYER_TYPE_NORMAL;
